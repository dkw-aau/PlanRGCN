...
public class PathComplexityChecker implements PathVisitor {
    ...
    public int mod_min = -1;
    public int mod_max = -1;
    ...
    public void visit(P_Link pathNode) {
        predicates.add(pathNode.toString());
    }
    ...
    public void visit(P_FixedLength pFixedLength) {
        ...
        mod_max = (int) pFixedLength.getCount();
        mod_min = 0;
    ...
    public void visit(P_Mod pathMod) {
        ...
        mod_max = (int) pathMod.getMax();
        mod_min = (int) pathMod.getMin();
