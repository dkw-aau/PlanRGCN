...
public class AlgebraFeatureExtractor {
	...
	public Map<String, Integer> getFeatureIndex() {
		return featureIndex;
	}
	...
	public static void test(String queryStr) {
