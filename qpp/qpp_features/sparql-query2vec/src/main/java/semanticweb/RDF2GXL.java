...
public class RDF2GXL {
	...
	//new
	public static XMLElement transformTriple2GXL(String subjectURI, String object) {
	...
	//new
	public static Graph getTestGXLGraph2() throws Exception {
		//XMLElement xml = new XMLElement();
		...
		String string1 = "tp1";
		String string2 = "tp2";
		XMLElement node1 = transformResourceURI2GXL(string1);
		
		XMLElement node3 = transformResourceURI2GXL(string2);
	
		graph.addChild(node1);
		graph.addChild(node3);
		
		XMLElement edge1 = transformTriple2GXL(string1, string2);
